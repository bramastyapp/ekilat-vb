...
Public Class ClsCtlPendaftaran : Implements InfProses
    ...
    Public Function insertData(Ob As Object) As OdbcCommand Implements InfProses.insertData
        ...
        data = Ob
        CMD = New OdbcCommand("insert into karyawan (`id_agen`, `nama_karyawan`, `alamat_karyawan`, `no_hp_karyawan`, `password`) values (" & data.Id_agen & ", '" & data.Nama_karyawan & "', '" & data.Alamat_karyawan & "', '" & data.No_hp_karyawan & "', '" & data.Password & "');", BUKAKONEKSI)
